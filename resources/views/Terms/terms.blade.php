...
<div class="row"style="margin-left:70%;">
 <div class="col-sm-6">
 @auth
    <a href="{{route('settings')}}"><h3 style="color:mediumvioletred;">Return</h3></a>
...
<p>
This website is owned by fluidbN Media ("We", "Us" or "fluidbN"). We are providing you with access to this Site subject to the following terms and conditions. By browsing, accessing,  or otherwise using our Services, you are agreeing to all of the following terms and conditions, including any policies referred to herein (collectively, these "Terms"). So, please read these Terms carefully. We reserve the right to change this Site and these Terms at any time. If you are unwilling to be bound by these Terms, you should not browse, access, use, register on the Site. You represent and warrant that you are at least 15 years old or visiting this Site under the supervision of a parent or guardian.
</p>

<h2> Use of This Site</h2>
<p>
Subject to your compliance with these Terms, We grant you a limited, non-exclusive, non-transferable, non-sub licensable license to access and make personal, non-commercial use of this Site. This license grant does not include: (a) any resale or commercial use of this Site or content therein; (b) making derivative uses of this Site and its contents; or (c) use of any data mining, robots, or similar data gathering and extraction methods on this Site. You may not use, frame or utilize framing techniques to enclose any of Our trademark, logo, content or other proprietary information (including the images found at this Site, the content of any text or the layout/design of any page or form contained on a page) without Our express written consent. Further, you may not use any meta tags or any other "hidden text" utilizing Our name, trademark, or product name without Our express written consent. Any breach of these Terms shall result in the immediate revocation of the license granted in this paragraph without notice to you. You are granted a limited, revocable, and nonexclusive right to create a hyperlink to the homepage of this Site so long as the link does not portray Us or Our products or services in a false, misleading, derogatory, or otherwise offensive matter. This limited right may be revoked at any time. You may not use any of Our logos or other proprietary graphics or trademarks as part of the link without express written permission.</p>
...
submit to this Site any content that is unlawful or facilitates, constitutes, promotes or encourages illegal activity; or otherwise use the Site to transfer or store illegal material, including any material deemed threatening or obscene or any pornographic content;
