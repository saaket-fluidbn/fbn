...
<div class="w3-dropdown-hover">
  ...
  <div id="" class="w3-dropdown-content w3-bar-block w3-card-4">
...
<nav class="w3-sidebar w3-bar-block w3-black w3-card w3-animate-left  w3-hide-large" style="display:none;width:100%;" id="mySidebar">
  ...
  <li class="nav-item dropdown">
      <button class="w3-button nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"  style="border:none;">
      @auth
